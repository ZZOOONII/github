...
-- 형식 : foregin key (열_이름) references 기준_테이블(열_이름)
...
-- 속성을 지정하지 않는다면, 컬럼이 정의된 순서대로 입력alter
insert into customer values ('happy', '최시은', '일본 오키나와', '01033331234', '1970-10-31');

-- 여러 튜플 동시 추가
insert into customer values 
('asdf', '강세희', '대한민국 부산', '01033331234', '2004-11-11'),
('hfsf', '윤지성', '일본 도쿄', '01033331235', '1990-02-15'),
('fswe', '이재은', '미국 뉴욕', '01033331236', '2003-10-31');
...
set FOREIGN_KEY_CHECKS = 1; -- error code : 1701 해결방법

truncate table customer;  -- truncate 데이터 삭제
